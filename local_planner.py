...
class LocalPlanner:
    ...
    def get_goal_state_set(self, goal_index, goal_state, waypoints, ego_state):
        ...
        if goal_index!=(len(waypoints)-1):
            delta_x = waypoints[goal_index+1][0]-goal_state[0]
            delta_y = waypoints[goal_index+1][1]-goal_state[1]
        else:
        ...
        # goal_x = np.dot(np.array([goal_state_local[0], goal_state_local[1]]),rot)[0]
        # goal_y = np.dot(np.array([goal_state_local[0], goal_state_local[1]]),rot)[1]
